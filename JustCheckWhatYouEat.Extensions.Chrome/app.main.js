(function ($, undefined) {
    ...
    Idea.FoodPicture.prototype = {
        ...
        Log: function (text) {
            if (Idea.Config.Debug)
                console.log(String.format("{0}; Category: {1}, Food: {2}, FoodId: {3}, PictureId: {4}", text, this.FoodInfo.Category, this.FoodInfo.Food, this.FoodInfo.Id, this.Id));
        }
    };
    ...
    Idea.FoodInfo.prototype = {
        ...
        Log: function (text) {
            console.log(String.format("{0}; Category: {1}, Food: {2}, FoodId: {3}", text, this.Category, this.Food, this.Id));
        }
    };
    ...
    var init = function () {
        ...
        $(document).on('mousewheel', Idea.Config.Selectors.Pictures, function (event, delta) {
            Idea.Config.Elem.$Pictures[0].scrollLeft -= (delta * 50);
